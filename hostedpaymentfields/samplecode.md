...
The following example PHP code shows how to send a **SALE** transaction with support for 3-D Secure using the Gateway library and using a `paymentToken`. The `paymentToken` represents the sensitive card data collected. Check our [sample code](samplecode.md#sample-code---hosted-payment-fields) to get a `paymentToken` using HTML.
...
Check our [sample code](samplecode.md#sample-code---hosted-payment-fields) to get a `paymentToken` using HTML.
...
The following example PHP code shows how to do a **PREAUTH** (amount £1,00) transaction with support for 3-D Secure using the [Gateway library](samplecode.md#gateway-library-php) and using a `paymentToken`. The `paymentToken` represents the sensitive card data collected. 
