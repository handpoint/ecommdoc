...
then
  ...
  sed -i "s/url: 'https://developer-ecomm.handpoint.io'/url: 'https://developer-ecomm.handpoint.com'/g" docusaurus.config.js
  sed -i 's/includeCurrentVersion: true/includeCurrentVersion: false/g' docusaurus.config.js
  sed -i "s/organizationName: 'handpointecomm'/organizationName: 'handpointecomm'/g" docusaurus.config.js
  sed -i "s/projectName: 'handpointecomm.github.io'/projectName: 'handpointecomm.github.io'/g" docusaurus.config.js
  sed -i 's/handpoint.io/handpoint.com/g' src/pages/index.js
  sed -i 's/developer-ecomm.handpoint.com/developer-ecomm.handpoint.com/g' static/CNAME
else
  sed -i 's/handpoint.io/handpoint.com/g' docusaurus.config.js
  sed -i "s/url: 'https://developer-ecomm.handpoint.com'/url: 'https://developer-ecomm.handpoint.io'/g" docusaurus.config.js
